...
<body>
        ...
        <div class="row">
            <div class="navbar navbar-inverse navbar-static-top">
                ...
                <div class="col-md-8 col-md-offset-8 login_info text-right">
                    ...
                    2018-12-13
                    <a class="pull-right" href="#"><i class="iconfont icon-dianyuan"></i></a>
                </div>
            </div>
        </div>
    </div>
    <div id="sidle_bar">
        ...
        <div class="sidlebar_content navbar-fixed-bottom">
            <a href="#collapse_system" data-toggle="collapse"><i class="iconfont icon-jia1"></i>系统设置</a>
            <ul id="collapse_system" class="collapse collapse_all">
                ...
                <li><a href="" data-iframesrc="${pageContext.request.contextPath}/admin/roleManager.html"><i class="iconfont icon-tubiaozhizuo-"></i>角色管理</a></li>
                <li><a href="" data-iframesrc="${pageContext.request.contextPath}/admin/resManager.html"><i class="iconfont icon-tubiaozhizuo-"></i>资源管理</a></li>
                <li><a href=""><i class="iconfont icon-tubiaozhizuo-"></i>系统信息管理</a></li>
                <li><a href=""><i class="iconfont icon-tubiaozhizuo-"></i>系统备份管理</a></li>
            </ul>
            <a href="#collapse_vedio" data-toggle="collapse"><i class="iconfont icon-jia1"></i>视频管理</a>
            ...
            <a href="#collapse_course" data-toggle="collapse"><i class="iconfont icon-jia1"></i>课程管理</a>
            ...
            <a href="#collapse_res" data-toggle="collapse"><i class="iconfont icon-jia1"></i>资料管理</a>
...
<iframe id="iframe-contant" class="navbar-fixed-bottom" frameborder="no" scrolling="auto" width="100%" height="100%" allowtransparency="true" src="${pageContext.request.contextPath}/static/html/admin_welcome.html" ></iframe>